...
foreach($all_desktop_ads as $formatted_desktop_ad):
    ...
    <a class="sidebar-callout" href="<?php echo $formatted_desktop_ad['art_combo'][$x]['ad_url'];?>">
      <img onload="ga('send', 'event', 'Advertising', 'Impression', '<?php echo $formatted_desktop_ad['ad_slug'] . '-desktop-art-' . $x;?>');" src="<?php echo $formatted_desktop_ad['art_combo'][$x]['ad_art'];?>"/>
    </a>
